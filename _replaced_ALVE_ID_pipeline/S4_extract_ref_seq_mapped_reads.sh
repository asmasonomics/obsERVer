...
samtools view "${outname}_viral_mapped_sorted.bam" | awk 'NR%2==1 {print "@"$1"#0/1\n"$10"\n+\n"$11}' > "${outname}_viral_mapped_read1.fastq"; gzip "${outname}_viral_mapped_read1.fastq"
samtools view "${outname}_viral_mapped_sorted.bam" | awk 'NR%2==0 {print "@"$1"#0/2\n"$10"\n+\n"$11}' > "${outname}_viral_mapped_read2.fastq"; gzip "${outname}_viral_mapped_read2.fastq"
